...
HHT_params = params = {'nx': nx, 'ny': ny, 'nz': nz,}

# prepare interface to run as a function
#def forward_model(s, ncores=None):
#    model = HHT_comsol.Model(HHT_params)
#    simul_obs = model.run_model(s)
#   return simul_obs

def forward_model(s, parallelization, ncores=None):
    model = Joint_comsol.Model(HHT_params)
